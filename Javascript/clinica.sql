...
CREATE TABLE `consultas` (
  ...
  CONSTRAINT `consultas_ibfk_3` FOREIGN KEY (`id_diagnostico`) REFERENCES `diagnosticos` (`id`),
  CONSTRAINT `consultas_ibfk_4` FOREIGN KEY (`id_tratamiento`) REFERENCES `tratamientos` (`id`)
...
CREATE TABLE `pacientes` (
  ...
  `nrotel` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-07-11 18:55:49
